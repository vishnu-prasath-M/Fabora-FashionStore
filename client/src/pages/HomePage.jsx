...
const HomePage = () => {
    ...
    return (
        <div>
            ...
            <section
                ref={heroRef}
                className="relative min-h-screen flex items-center bg-gradient-to-br from-primary/5 via-white to-secondary/10 overflow-hidden"
            >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="space-y-8">
                            <div className="inline-block">
                                <span className="hero-subtitle bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-semibold">
                                    ✨ New Fashion Collection 2024
                                </span>
                            </div>

                            <h1 className="hero-title text-5xl md:text-6xl lg:text-7xl font-heading font-bold text-secondary leading-tight">
                                Elevate Your
                                <span className="block text-primary">Fashion Game</span>
                            </h1>

                            <p className="hero-subtitle text-lg md:text-xl text-gray-600 max-w-lg">
                                Discover premium fashion pieces curated just for you. From timeless classics to the latest trends, express your unique style with confidence.
                            </p>

                            <div className="hero-cta flex flex-col sm:flex-row gap-4">
                                <Link to="/shop" className="btn-primary inline-flex items-center justify-center gap-2 px-8 py-4 text-lg">
                                    Shop Now <ArrowRight className="w-5 h-5" />
                                </Link>
                                <a href="#featured" className="btn-outline inline-flex items-center justify-center px-8 py-4 text-lg">
                                    Explore Collection
                                </a>
                            </div>
                            ...
                            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-gray-200">
                                <div>
                                    ...
                                    <p className="text-gray-600 text-sm">Fashion Items</p>
                                </div>
                                <div>
                        ...
                        <div className="relative lg:h-[600px] grid grid-cols-2 gap-4">
                            <div className="space-y-4">
                                <div className="hero-image aspect-[3/4] rounded-2xl overflow-hidden shadow-xl">
                                    <img
                                ...
                                <div className="hero-image aspect-square rounded-2xl overflow-hidden shadow-xl">
                                    <img
